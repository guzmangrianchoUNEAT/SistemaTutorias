...
import Button from '../components/Button'; // Importar tu componente de botón
...
export default function ProfileScreen({ navigation }: ProfileScreenProps) {
  const [userProfile, setUserProfile] = useState({
    name: '',
    email: '',
    avatar: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8AJM9wkP__z2M-hovSAWcTb_9XJ6smy3NKw&s', // URL de una imagen de perfil por defecto
  });
