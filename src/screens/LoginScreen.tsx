...
export default function LoginScreen({ navigation }: any) {
  ...
  return (
    <ImageBackground
      source={{ uri: 'https://images.unsplash.com/photo-1557683316-973673baf926' }} // Imagen de fondo
    ...
    >
      <View style={styles.container}>
        ...
        <Button
          title={loading ? 'Cargando...' : 'Iniciar Sesión'} // Muestra "Cargando..." si está en proceso
          onPress={handleLogin}
